...
voting_names = YAML::load <<YAML_TEXT
poll: 1
received_by_commission: 2
voted_early: 3
voted_in: 4
voted_out: 5
canceled_ballots: 6
mobile_ballots: 7
stationary_ballots: 8
invalid_ballots: 9
valid_ballots: 10
absentee_ballots_all: 11
absentee_ballots_given: 12
absentee_ballots_voted: 13
unused_absentee_ballots: 14
absentee_territorial: 15
lost_absentee_ballots: 16
lost_ballots: 17
ballots_not_taken: 18
sr: 19
ldpr: 20
pr: 21
kprf: 22
...
#      voting_names = {        "poll"=>1,        "received_by_commission"=>2,        "voted_early"=>3,        "voted_in"=>4,        "voted_out"=>5,"canceled_ballots"=>6,"mobile_ballots"=>7,"stationary_ballots"=>8,"invalid_ballots"=>9,"valid_ballots"=>10,"absentee_ballots_all"=>11,"absentee_ballots_given"=>12,"absentee_ballots_voted"=>13,"unused_absentee_ballots"=>14,"absentee_territorial"=>15,"lost_absentee_ballots"=>16,"lost_ballots"=>17,"ballots_not_taken"=>18,"sr"=>19,"ldpr"=>20,"pr"=>21,"kprf"=>22,"yabloko"=>23,"er"=>24,"pd"=>25}
      voting_labels = YAML::load <<YAML_TEXT2
poll: "Число избирателей, внесенных в список избирателей"
received_by_commission: "Число избирательных бюллетеней, полученных участковой избирательной комиссией"
voted_early: "Число избирательных бюллетеней, выданных избирателям, проголосовавшим досрочно"
voted_in: "Число избирательных бюллетеней, выданных избирателям в помещении для голосования"
voted_out: "Число избирательных бюллетеней, выданных избирателям вне помещения для голосования"
canceled_ballots: "Число погашенных избирательных бюллетеней"
mobile_ballots: "Число избирательных бюллетеней в переносных ящиках для голосования"
stationary_ballots: "Число избирательных бюллетеней в стационарных ящиках для голосования"
...
absentee_ballots_all: "Число открепительных удостоверений, полученных участковой избирательной комиссией"
absentee_ballots_given: "Число открепительных удостоверений, выданных избирателям на избирательном участке"
absentee_ballots_voted: "Число избирателей, проголосовавших по открепительным удостоверениям на избирательном участке"
unused_absentee_ballots: "Число погашенных неиспользованных открепительных удостоверений"
absentee_territorial: "Число открепительных удостоверений, выданных избирателям территориальной избирательной комиссией"
lost_absentee_ballots: "Число утраченных открепительных удостоверений"
lost_ballots: "Число утраченных избирательных бюллетеней"
ballots_not_taken: "Число избирательных бюллетеней, не учтенных при получении"
sr: "Политическая партия СПРАВЕДЛИВАЯ РОССИЯ"
ldpr: "Политическая партия Либерально-демократическая партия России"
pr: "Политическая партия ПАТРИОТЫ РОССИИ"
kprf: "Политическая партия Коммунистическая партия Российской Федерации"
yabloko: "Политическая партия Российская объединенная демократическая партия ЯБЛОКО"
