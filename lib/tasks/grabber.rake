...
voting_names = YAML.parse <<YAML_TEXT
poll: 
  1
received_by_commission:
  2
voted_early:
  3
voted_in:
...
valid_ballots:
  10
absentee_ballots_all:
  11
absentee_ballots_given:
  12
absentee_ballots_voted:
  13
unused_absentee_ballots:
  14
absentee_territorial:
  15
lost_absentee_ballots:
  16
lost_ballots:
  17
ballots_not_taken:
...
#      voting_names = {        "poll"=>1,        "received_by_commission"=>2,        "voted_early"=>3,        "voted_in"=>4,        "voted_out"=>5,"canceled_ballots"=>6,"mobile_ballots"=>7,"stationary_ballots"=>8,"invalid_ballots"=>9,"valid_ballots"=>10,"absentee_ballots_all"=>11,"absentee_ballots_given"=>12,"absentee_ballots_voted"=>13,"unused_absentee_ballots"=>14,"absentee_territorial"=>15,"lost_absentee_ballots"=>16,"lost_ballots"=>17,"ballots_not_taken"=>18,"sr"=>19,"ldpr"=>20,"pr"=>21,"kprf"=>22,"yabloko"=>23,"er"=>24,"pd"=>25}
      voting_labels = YAML.parse <<YAML_TEXT2
poll:
